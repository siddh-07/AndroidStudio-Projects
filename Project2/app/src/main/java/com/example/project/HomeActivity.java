    ...
    public void AddData(){
        ...
        addData.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isInserted == true){
                    Toast.makeText( HomeActivity.this, "Data is inserted", Toast.LENGTH_SHORT ).show();
                }
                else
                    Toast.makeText( HomeActivity.this, "Data is not inserted", Toast.LENGTH_SHORT ).show();
            }
        } );
    }
