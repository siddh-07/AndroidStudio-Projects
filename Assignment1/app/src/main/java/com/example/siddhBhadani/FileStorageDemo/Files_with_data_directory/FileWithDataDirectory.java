package com.example.siddhBhadani.FileStorageDemo.Files_with_data_directory;
...
import com.example.matchmemory.R;
...
public class FileWithDataDirectory extends AppCompatActivity {
    ...
    private void writeToFileInDataDir() {
        ...
        try (FileOutputStream fileOutputStream =
                     openFileOutput(FileWithDataDirectory.FILE_NAME,
            ...
            Toast.makeText(FileWithDataDirectory.this, "File Saved",
