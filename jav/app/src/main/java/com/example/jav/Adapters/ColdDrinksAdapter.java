...
public class ColdDrinksAdapter extends RecyclerView.Adapter<ColdDrinksAdapter.viewholder> {
    ArrayList<ColdDrinksModel> blist;
    Context context;

    public ColdDrinksAdapter(ArrayList<ColdDrinksModel> blist, Context context) {
        this.blist = blist;
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_cold_drinks, parent, false);
        return new ColdDrinksAdapter.viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull viewholder holder, int position) {
        final ColdDrinksModel bmodel = blist.get(position);
