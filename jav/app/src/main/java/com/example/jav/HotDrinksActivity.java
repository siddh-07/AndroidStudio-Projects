...
import com.example.jav.databinding.ActivityHotDrinksBinding;

import java.util.ArrayList;

public class HotDrinksActivity extends AppCompatActivity {
    ActivityHotDrinksBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // setContentView(R.layout.activity_cold_drinks);
        binding = ActivityHotDrinksBinding.inflate(getLayoutInflater());
        ...
        binding.recyclerviewHot.setLayoutManager(layoutManager);
